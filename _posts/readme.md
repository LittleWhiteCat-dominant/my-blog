---
title: 'The Build Series: E6 — Fun with Flags'
excerpt: 'The decision of when to release new software features is controlled by the business and is independent of the engineering sprints (or KanBan if that is your thing). In such cases, the engineering team has already pushed the feature out to production, but the rollout date is at a later time in the future.'
coverImage: 'https://dhanrajsp.me/static/images/knobs.jpg'
date: '2020-03-16T05:35:07.322Z'
author:
  name: dhanraj
  picture: '/assets/blog/authors/joe.jpeg'
ogImage:
  url: 'https://dhanrajsp.me/static/images/knobs.jpg'
---
