...
export const projects = [
    {
        ...
        theme: 'btn-back-red',
        name: 'Deli Eplus APP',
        description: 'Established the Deli EPlus platform from scratch, overseeing continuous enhancement over three years. The platform has successfully served over 30 million users, generating a stable monthly profit of 300,000 RMB. The platform enables add and manage office devices which connects to the MQTT-based cloud.',
    ...
    },
    {
        ...
        description: 'Developed the ReactNative mobile application for Deli, in collaboration with Huawei, specifically for inkjet printer. Led team of 12 developed a cross-platform app, inclusive of LAN and cloud printing, serving millions of users.',
    ...
    },
    {
        ...
        theme: 'btn-back-blue',
        name: 'Deli Print App',
        description: 'Implemented the website and mini-program for Deli Printing, with the goal of providing users with a convenient and swift printing experience.',
    ...
    },
    {
        ...
        name: 'One Plus 3 & 2',
        description: 'Optimized application performance through various aspects such as memory consumption, open speed, power consumption, and sliding performance.',
    ...
    },
    {
        ...
        description: 'Developed the Neoway OEM phone, including features for MMS, Contact and Phone App',
