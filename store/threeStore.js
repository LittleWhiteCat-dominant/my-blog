...
// import * as audio from '../components/assets/audio-control'
import CustomSinCurve from "../components/three/CustomSinCurve";

let guid = 1;

const useStore = createWithEqualityFn((set, get) => {
  const path = new CustomSinCurve(10);
  let track = new THREE.TubeGeometry(path, 250, 0.2, 10, true);
